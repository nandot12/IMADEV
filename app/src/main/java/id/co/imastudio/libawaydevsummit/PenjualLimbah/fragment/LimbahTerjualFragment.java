 ...
 */
public class LimbahTerjualFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_limbah_terjual, container, false);
